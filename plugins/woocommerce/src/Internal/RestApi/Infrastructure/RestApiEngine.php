			...
			function () {
				...
				register_rest_route(
					...
					array(
						...
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controller\BarController', 'patch_rofl', $request, '', false ),
				...
				register_rest_route(
					...
					array(
						'methods'             => 'GET',
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controllers\FooController', 'get_fizz', $request, 'treintaicuatror,foozer', false ),
				...
				register_rest_route(
					...
					array(
						'methods'             => 'POST,PATCH',
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controllers\FooController', 'post_fizz', $request, 'administratorx,pepe', false ),
						'permission_callback' => fn() => get_current_user_id() !== 0,
					)
				);
				...
				register_rest_route(
					'wc/v4',
					'/foo/fizz/num/(?P<num>[\d]+)',
					array(
						'methods'             => 'GET',
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controllers\FooController', 'get_fizz_num', $request, 'treintaicuatror,foozer', false ),
						'permission_callback' => '__return_true',
					)
				);
				...
				register_rest_route(
					'wc/v4',
					'/foo/fizz/date/(?P<date>([0-9]{4})-(1[0-2]|0[1-9])-(3[01]|0[1-9]|[12][0-9]))',
					array(
						'methods'             => 'GET',
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controllers\FooController', 'get_fizz_date', $request, 'treintaicuatror,foozer', false ),
						'permission_callback' => '__return_true',
					)
				);
				...
				register_rest_route(
					'wc/v4',
					'/foo/fizz/post/(?P<num>[\d]+)',
					array(
						'methods'             => 'GET',
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controllers\FooController', 'get_fizz_post', $request, '', false ),
						'permission_callback' => fn() => get_current_user_id() !== 0,
					)
				);
				...
				register_rest_route(
					...
					array(
						'methods'             => 'GET',
						'callback'            => fn( \WP_REST_Request $request ) =>
							static::safe_invoke( 'Automattic\WooCommerce\Internal\RestApi\Controller\TestController', 'administrator_only', $request, '', false ),
						'permission_callback' => fn() => get_current_user_id() !== 0,
					)
				);
